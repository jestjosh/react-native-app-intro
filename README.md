...
For older versions of React Native (< 0.60), please use version 1.1.5 of this package.
...
```bash
$ npm install react-native-app-intro --save
# or
$ yarn add react-native-app-intro
```
